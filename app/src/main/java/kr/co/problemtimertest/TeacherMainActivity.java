...
public class TeacherMainActivity extends AppCompatActivity {
    ...
    private TeacherAssignmentFragment teacherAssignmentFragment;
            ...
            public void run() {
                ...
                handler.post(new Runnable() {
                     ...
                     public void run() {
                         ...
                         // 첫째 프래그먼트를 디폴트로 설정한다.
                         getSupportFragmentManager().beginTransaction().replace(R.id.container_teacher_main, managementFragment).commit();
                                         ...
                                         switch (item.getItemId()) {
                                             ...
                                             case R.id.tab_management:
                                                 getSupportFragmentManager().beginTransaction()
                                                         .replace(R.id.container_teacher_main, managementFragment).commit();

                                                 return true;

                                             case R.id.tab_assignment_teacher:
                                                 getSupportFragmentManager().beginTransaction()
                                                         .replace(R.id.container_teacher_main, teacherAssignmentFragment).commit();
                                         }
    ...
    private void initializeVariable() {
        ...
        teacherAssignmentFragment = new TeacherAssignmentFragment();
    }
    ...
    private void initializeTeacher() {
        ...
        Call<Teacher> call = loginApi.readTeacher(mFirebaseAuth.getCurrentUser().getEmail());
    ...
    private boolean isTeacherNullForNms(long n) {
        ...
        Log.d("error", "failed to get : teacher");

        handler.post(new Runnable() {

            @Override
            public void run() {
                Toast.makeText(TeacherMainActivity.this, "선생님 정보를 받아오지 못했습니다.", Toast.LENGTH_SHORT).show();
            }
        });
